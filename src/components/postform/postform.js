        ...
        <Formik
          validationSchema={Yup.object().shape({
            ...
            instrumentType: Yup.string()
              .required("Don't forget to enter the type of your gear"),
            instrumentName: Yup.string()
              .required("Don't forget to enter the make and model of your gear"),
            condition: Yup.string()
              .required("Don't forget to enter the condition of your gear"),
            price: Yup.string()
              .required("Don't forget to enter your asking price")
          })}
          initialValues={{
            image: "",
            title: "",
